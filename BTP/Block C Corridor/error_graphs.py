...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "candlestick_block_c_wknn")
...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "candlestick_block_c_nlls")
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()
...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "cdf_block_c")
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()