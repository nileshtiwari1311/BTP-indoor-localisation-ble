...
for i in range(1, 60) :
	if i%2 == 0:
		data_point = (i, 1)
		if 1 in beacon_data[data_point] :
			rssi_list_1.append(beacon_data[data_point][1])
			x_list_1.append(i)
		data_point = (i, 5)
		if 1 in beacon_data[data_point] :
			rssi_list_5.append(beacon_data[data_point][1])
			x_list_5.append(i)
	else :
		data_point = (i, 3)
		if 1 in beacon_data[data_point] :
			rssi_list_3.append(beacon_data[data_point][1])
			x_list_3.append(i)
