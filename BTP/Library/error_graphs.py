...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "candlestick_library_wknn")
...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "candlestick_library_nlls")
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()
...
plt.grid()
# plt.show()
filename = os.path.join(save_path, "cdf_library")
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()