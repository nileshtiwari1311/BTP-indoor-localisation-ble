...
# candlestick
# wknn
data_dir = os.getcwd() + "/error-database-wknn/"
...
plt.grid()
# plt.show()
filename = "candlestick_library_wknn"
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()

#nlls
data_dir = os.getcwd() + "/error-database-nlls/"
f = open(os.path.join(data_dir, "beacon_error_database_complete.json"), "r")
data = json.load(f)
f.close()
...
plt.grid()
# plt.show()
filename = "candlestick_library_nlls"
plt.savefig(filename, dpi=200, bbox_inches='tight')
plt.close()
